      ...
      <div className="container mx-auto px-6 max-w-6xl">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative">
            {/* Card */}
            <div className="relative bg-black border-2 border-yellow-500/30 rounded-2xl p-8 text-center">
              ...
              {/* Price */}
              <div className="mb-4">
                <div className="text-7xl md:text-8xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 to-yellow-600">
                  €XXX
                </div>
              </div>
              ...
              <button className="relative group w-full">
                ...
                <div className="relative bg-gradient-to-r from-yellow-400 to-yellow-600 text-black font-bold text-lg px-8 py-4 rounded-full transition-all group-hover:scale-105 flex items-center justify-center gap-2">
                  QUERO ME INSCREVER
                  <svg 
